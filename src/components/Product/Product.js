    ...
    return (
        <div className='bg-violet-100 my-4 rounded-lg'>
            ...
            <div className='p-4'>
                ...
                <button className='active:bg-blue-200 bg-indigo-200 block my-2 px-4 py-2 active:ring-2 ring-offset-2 ring-blue-500 rounded-md text-blue-700'>Add to cart <i className="fa-solid fa-cart-plus"></i></button>
            </div>
        </div>
    );
};
